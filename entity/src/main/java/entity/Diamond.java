...
public class Diamond  extends  Sprie_fall{
    private static String NAME = "src/model/Model/data/wall_empty/rock.png";
    private static int Widht = 32;
    private static int HEIGHT =32;

    private static  String []state={"C:\\Users\\Gfried\\Downloads\\projet\\JPU-BlankProject\\JPU-BlankProject\\model\\src\\main\\java\\model\\data\\Diamond\\"};
    private List<Image> im;
    private File[] liste;
    private String path;

    public Diamond( Point point) throws IOException {
