...
public class Monster extends  Sprie_fall{
    private static String NAME = "src/java/model/data/wall_empty/rock.png";
    private static int Widht = 32;
    private static int HEIGHT =32;

    private static  String []state={"src/main/java/model/data/Monster/"};
    private List<Image> im;
    private File[] liste;
    private String path;

    public Monster( Point point) throws IOException {
